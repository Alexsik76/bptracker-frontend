...
describe('delta computation', () => {
  it('computes deltaSys and deltaDia when both windows have ≥3 items', () => {
    const items = [
      ...
      m(130, 85, 75, 1 * DAY), m(130, 85, 75, 2 * DAY), m(130, 85, 75, 3 * DAY),
      // prev 7 days — avg sys=120, dia=80
      m(120, 80, 70, 8 * DAY), m(120, 80, 70, 9 * DAY), m(120, 80, 70, 10 * DAY),
    ]
    const v = useKpi(items).value!
  ...
  it('deltaIcon ↓ and color success when sys decreased', () => {
    const items = [
      m(110, 75, 65, 1 * DAY), m(110, 75, 65, 2 * DAY), m(110, 75, 65, 3 * DAY),
      m(130, 85, 75, 8 * DAY), m(130, 85, 75, 9 * DAY), m(130, 85, 75, 10 * DAY),
    ]
    const v = useKpi(items).value!
    expect(v.deltaIcon).toBe('↓')
  ...
  it('deltaIcon → when deltaSys is exactly 0', () => {
    const items = [
      m(120, 80, 70, 1 * DAY), m(120, 80, 70, 2 * DAY), m(120, 80, 70, 3 * DAY),
      m(120, 80, 70, 8 * DAY), m(120, 80, 70, 9 * DAY), m(120, 80, 70, 10 * DAY),
    ]
    const v = useKpi(items).value!
  ...
  it('delta is null when fewer than 3 items in either window', () => {
    const items = [
      // only 2 in last7
      m(130, 85, 75, 1 * DAY), m(130, 85, 75, 2 * DAY),
      // 3 in prev7
      m(120, 80, 70, 8 * DAY), m(120, 80, 70, 9 * DAY), m(120, 80, 70, 10 * DAY),
    ]
...
describe('stability (P7)', () => {
  ...
  it('no NaN in any numeric field', () => {
    const v = useKpi([m(120, 80, 70, DAY)]).value!
    const numericFields = [v.avgSys, v.avgDia, v.avgPulse, v.normalShare, v.deltaSys, v.deltaDia] as const
